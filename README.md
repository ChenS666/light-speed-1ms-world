...
[`光速降到1m/s的世界.html`](光速降到1m/s的世界.html) —— 单文件自包含（内联 Three.js），浏览器打开即运行。拖动"真空光速 c"滑块即可看到世界从正常逐步走向隧道化的全过程，支持路边/车上双视角与八幕自动演示。
...
```
├── 光速降到1m/s的世界.html       # AI 交付物：自包含 3D 动画（直接双击打开）
├── prompt/
